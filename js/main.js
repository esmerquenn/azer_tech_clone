...
function gridwithfilter() {
  ...
  prodcnt.hover(
    function () {
      jQuery(this).find(".product-add-to-cart a.darna-button.style3").slideDown();
      jQuery(this).find(".product-add-to-cart .price").slideUp();
    },
    function () {
      jQuery(this).find(".product-add-to-cart a.darna-button.style3").slideUp();
      jQuery(this).find(".product-add-to-cart .price").slideDown();
    }
  );
  /*
...
function isotope_() {
  ...
  folio_filter_links.click(function () {
    ...
    folio_filter_parent.find(".active").removeClass("active");
  ...
  gallery_filters_links.click(function () {
    ...
    gallery_filters_parent.find(".active").removeClass("active");
    jQuerythis.addClass("active");
    // make option object dynamically, i.e. { filter: '.my-filter-class' }
    var options = {},
